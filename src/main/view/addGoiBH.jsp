...
<%--                            </caption>--%>
                            <fieldset class="form-group" >
                                <label>Tên gói BH:</label> <input type="text" class="form-control"
                                                           name="ten" required="required" value="${ten}">
                            </fieldset>

                            <fieldset class="form-group">
                                <label>Giá tiền (VND):</label> <input type="number" value="${tien}" required="required" min="1" max="999999999999" class="form-control"
                                                                name="tien">
                            </fieldset>

                            <fieldset class="form-group">
                                <label>Thời gian đóng (Tháng):</label> <input type="number" value="${thoiGian}" required="required" min="1" max="999" class="form-control"
                                                                      name="thoiGian">
                            </fieldset>
