...
<head>
    <title>Xem thông tin chi tiết tài khoản</title>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group" style="background-color:lightsteelblue">
                        <li class="list-group-item">User Name: <%= ((TaiKhoan) session.getAttribute("customer")).getUsername() %>
                        </li>
                        <li class="list-group-item">Họ và tên: <%= ((TaiKhoan) session.getAttribute("customer")).getTen()%></li>
                        ...
                        <li class="list-group-item">Quyền: <%= ((TaiKhoan) session.getAttribute("customer")).getLoai() %> </li>
                    </ul>
                    <br>
                </div>
            </div>
